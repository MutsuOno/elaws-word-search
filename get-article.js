...
function doTask() {
    ...
    var export_xml = 'articles.xml'; 

    writeXML(export_xml, '<?xml version="1.0" encoding="UTF-8"?>\n<DataRoot>\n');
    ...
    for (var i = 0; i < csv.length; i++) {
        ...
        var content = removeHeader(hourei);
        var content_with_name = insertLawName(content, law_name);

        writeXML(export_xml, content_with_name);
